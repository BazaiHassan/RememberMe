<template>
    <base-dialog v-if="isInputInvalid" title="Invalid Input" @close="confirmError">
        <template v-slot:default>
            ...
            <p>Please check all inputs and make sure you enter at least a character.</p>
        </template>
    ...
    <base-card>
        <form @submit.prevent="submiteData">
            ...
            <div>
                <base-button class="add-btn" type="submit">Add Resource</base-button>
            </div>
        </form>
    </base-card>
</template>
